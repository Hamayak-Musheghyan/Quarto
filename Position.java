...
/**
 * This is a class for storing and representing a position on a Quarto board.
...
public class Position {
    ...
    /*
     * Position row on the board, starting from the bottom.
    ...
    /*
     * Position column on the board, starting from the left.
    ...
    private Position(Position position) {
        ...
        this.setColumn(position.column);
    }
     ...
     * <code>Position</code> with a format like "C2".
     *
    ...
    /**
     * Returns a <code>Position</code> object based on the provided
     * arguments for row and column
     *
     * @return          the <code>Position</code> object
     */

    private static Position generatePosition(int row, int column){
